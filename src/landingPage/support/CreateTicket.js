  ...
  return (
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="">
          <i class="fa-solid fa-user-plus"></i> Zerodha Account 
          </h4>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="">
          <i class="fa-solid fa-shop"></i> Trading & Markets
          </h4>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="">
          <i class="fa-solid fa-circle-info"></i>  Console
          </h4>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="">
          <i class="fa-solid fa-globe"></i> Coin
          </h4>
